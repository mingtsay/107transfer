...
if(school.published){var table=_C('table'),table_body=_C('tbody'),price=_C('tr'),price_head=_C('th'),price_content=_C('td'),regist=_C('tr'),regist_head=_C('th'),regist_content=_C('td'),tests=_C('tr'),tests_head=_C('th'),tests_content=_C('td')
